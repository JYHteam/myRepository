...
<div id="books_windows" class="easyui-window" style="width:600px;height:800px;" title="书籍添加" data-options="closed:true,modal:true">
        ...
        <form id="books_form" >
            ...
            书籍类型：<input name="book_typeid" class="easyui-combobox" data-options="url:'pfindAllBookTypes.do',valueField:'id', textField:'books_type',panelHeight:'auto' "/><br/>
            书籍图片：<input id="book_image" name="book_image" type="file" onchange="showpic(this)"/>
            <%--显示将要上传的图片--%>
            <span id="pics" style="width: 50px;height: 50px">
           </span>
